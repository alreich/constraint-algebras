...
(defun SETUP-TEST-NET (objects constraints &key (propagate-p t))
  (let ((net (initialize-constraint-network
	      'linear-interval :obj-eq-test #'string=)))
...
(setf net (setup-test-net *OBJECTS-2*
			  (append *INITIAL*
				  *STACK-A-B*
				  *STACK-B-C*
				  *DOMAIN-CONSTRAINTS-1*)))

(setf net-no-prop (setup-test-net *OBJECTS-2*
			          (append *INITIAL*
				          *STACK-A-B*
				          *STACK-B-C*
				          *DOMAIN-CONSTRAINTS-1*)
...
Elapsed Real Time = 6.49 seconds
Total Run Time    = 6.48 seconds
User Run Time     = 6.47 seconds
System Run Time   = 0.01 seconds
Process Page Faults    =        184
Dynamic Bytes Consed   =          0
Ephemeral Bytes Consed =    112,432

;;; On an HP Series 400:

Elapsed Real Time = 42.87 seconds
Total Run Time    = 41.56 seconds
User Run Time     = 41.52 seconds
System Run Time   = 0.04 seconds
Dynamic Bytes Consed   =        816
Ephemeral Bytes Consed =  8,952,744
